...
property[0] = "Area";
unit[0] = new Array("Square Meter (m^2)", "Acre (acre)", "Are(ar)", "Barn (barn)", "Hectare(ha)", "Rood(rood)", "Square Centimeter(cm^2)", "Square Kilometer(km^2)", "Circular Mil(cmil)", "Square Foot (ft^2)", "Square Inch (in^2)", "Square Mile (mi^2)", "Square Yard (yd^2)");
